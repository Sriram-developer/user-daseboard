  ...
  return (
    <div className='flex gap-4 w-full'>
          ...
          <BoxWrapper>
				...
				<div className="pl-4">
					<span className="text-sm text-gray-500 font-light">User Expenses</span>
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">RS 84230</strong>
						<span className="text-sm text-green-500 pl-2">-343</span>
					</div>
				</div>
			</BoxWrapper>
			<BoxWrapper>
				...
				<div className="pl-4">
					...
					<div className="flex items-center">
						<strong className="text-xl text-gray-700 font-semibold">112313</strong>
